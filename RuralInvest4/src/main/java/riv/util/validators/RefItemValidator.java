...
public class RefItemValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (obj.getClass().isAssignableFrom(ReferenceCost.class)){
			...
			ValidateUtils.rejectIfZeroOrNegative(i, "unitCost", "reference.cost.unitCost", errors);
			...
			ValidateUtils.rejectIfZeroOrNegative(i, "unitCost", "reference.income.unitCost", errors);
			...
			ValidateUtils.rejectIfZeroOrNegative(i, "unitCost", "reference.labour.unitCost", errors);
		} 
	}
}