...
public class ProjectItemPersonnelWithout extends ProjectItem  {//implements GeneralCosts { 
	...
	public Double getExternal() {
	 ...
	 public String testingProperties(CurrencyFormatter cf) {
		   ...
		   sb.append("step8.personnelWo."+(this.getOrderBy()+1)+".unitType="+unitType+System.lineSeparator());
		   sb.append("step8.personnelWo."+(this.getOrderBy()+1)+".unitNum="+unitNum+System.lineSeparator());
	...
	@Override
	 public ProjectItemPersonnelWithout copy() {
		ProjectItemPersonnelWithout item = new ProjectItemPersonnelWithout();
