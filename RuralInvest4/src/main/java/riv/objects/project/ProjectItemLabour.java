...
public class ProjectItemLabour extends ProjectItem implements ProjectInvestment {
	...
	public Double getFinanced() {
	   ...
	   public String testingProperties(CurrencyFormatter cf) {
		   ...
		   sb.append("step7.labour."+(this.getOrderBy()+1)+".unitType="+unitType+System.lineSeparator());
		   sb.append("step7.labour."+(this.getOrderBy()+1)+".unitNum="+unitNum+System.lineSeparator());
