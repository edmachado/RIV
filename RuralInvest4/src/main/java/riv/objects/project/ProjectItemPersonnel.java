...
public class ProjectItemPersonnel extends ProjectItem {// implements GeneralCosts { // GeneralCostsDetail
	...
	public Double getExternal() {
	 ...
	 public String testingProperties(CurrencyFormatter cf) {
		   ...
		   sb.append("step8.personnel."+(this.getOrderBy()+1)+".unitType="+unitType+System.lineSeparator());
		   sb.append("step8.personnel."+(this.getOrderBy()+1)+".unitNum="+unitNum+System.lineSeparator());
