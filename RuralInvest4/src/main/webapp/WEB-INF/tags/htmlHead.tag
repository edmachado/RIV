<%@ include file="/WEB-INF/jsp/inc/include.jsp" %><meta http-equiv="content-type" content="text/html; charset=utf-8"/>
	...
	<script src="<c:url value="/scripts/general.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/scripts/jquery-1.9.1.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/scripts/jquery-ui-1.10.3.custom.min.js"/>" type="text/javascript"></script>
	<script src="<c:url value="/scripts/jquery.barrating.min.js"/>" type="text/javascript"></script>
	<link href="<c:url value="/styles/riv-theme/jquery-ui-1.10.3.custom.css"/>" rel="stylesheet"/>
	<link href="<c:url value="/styles/css-stars.css"/>" rel="stylesheet" />
