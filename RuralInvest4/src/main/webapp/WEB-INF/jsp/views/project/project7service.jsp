...
<html><head><title><spring:message code="projectInvestService"/></title>
<script>
	...
	<form:form name="form" method="post" commandName="projectItem">
		...
		<div style="display:inline-block;width:470px">
			<fieldset>
				...
				<tags:projYear field="yearBegin" labelKey="projectInvestService.yearBegin" helpText="projectInvestService.yearBegin.help" />
			</fieldset>
		</div>
