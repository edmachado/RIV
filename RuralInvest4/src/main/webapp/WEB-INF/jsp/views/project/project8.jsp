...
<form:form name="form" method="post" commandName="project">
	...
	<div align="left">
	 	...
	 	<img src="../../img/xls.gif" alt="Excel" title="Excel"/> <a id="downloadTemplate" href="../../report/${project.projectId}/projectGeneralDetail.xlsx"><spring:message code="export.download"/></a><br/>
