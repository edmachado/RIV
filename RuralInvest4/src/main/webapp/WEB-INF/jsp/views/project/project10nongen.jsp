...
<form:form name="form" method="post" commandName="project">
	...
	<div align="left">
		...
		<c:if test="${accessOK}"><spring:message code="import.importExcel"/> in progress <%--<a id="importExcel" href="#"><img src="../../img/xls.gif" alt="Excel" title="Excel"/> <spring:message code="import.importExcel"/></a>--%></c:if> 
 	</div>
