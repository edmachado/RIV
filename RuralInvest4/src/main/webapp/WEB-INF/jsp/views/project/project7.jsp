...
<form:form name="form" method="post" commandName="project">
	...
	<div align="left">
	 	<img src="../../img/xls.gif" alt="Excel" title="Excel"/> <a href="../../report/${project.projectId}/projectInvestDetail.xlsx?template=true"><spring:message code="export.downloadTemplate"/></a><br/>
	 	<img src="../../img/xls.gif" alt="Excel" title="Excel"/> <a href="../../report/${project.projectId}/projectInvestDetail.xlsx"><spring:message code="export.download"/></a><br/>
	 	<%-- 
