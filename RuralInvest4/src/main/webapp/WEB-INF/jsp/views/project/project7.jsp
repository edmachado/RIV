...
<html><head><title><spring:message code="project.step7"/></title>
<script>
$(function() {
...
<form:form name="form" method="post" commandName="project">
	...
	<div align="left">
	 	...
	 	<img src="../../img/xls.gif" alt="Excel" title="Excel"/> <a id="downloadExcel" href="../../report/${project.projectId}/projectInvestDetail.xlsx" target="_blank"><spring:message code="export.download"/></a><br/>
	...
	<div id="tabs">
		...
		<div id="tabs-with">
			<span class="error"><form:errors path="assets" cssClass="error" element="div" /></span>
			...
			<span class="error"><form:errors path="labours" cssClass="error" element="div" /></span>	
			...
			<span class="error"><form:errors path="services" cssClass="error" element="div" /></span>
