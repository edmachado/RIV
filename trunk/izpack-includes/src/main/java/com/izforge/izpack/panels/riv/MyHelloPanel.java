...
package com.izforge.izpack.panels.riv;
...
*/
    public MyHelloPanel(Panel panel, InstallerFrame parent, GUIInstallData idata, Resources resource, Log log)
    {
        this(panel, parent, idata, new IzPanelLayout(log), resource);
    }
